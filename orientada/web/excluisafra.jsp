...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1 class="text-center">Excluir Safras</h1>
            <a class="btn btn-primary col-md-2 my-4" href="listasafra.jsp">Voltar</a><br>
            <%
                int codigo = Integer.parseInt(request.getParameter("codigo"));
                String mensagem = "<div class='alert alert-danger col-md-6'>Deseja realmente excluir essa safra com o codigo " + codigo + " ? </div>";
                if (request.getParameter("btnExclui") != null) {
                    Connection conexao = Conexao.getConexao();
                    boolean excluiu = SafraDB.SetExcluiSafra(codigo, conexao);
                    if (excluiu) {
                        mensagem = "<div class='alert alert-success col-md-6'>Safra excluída com sucesso! </div>";
                    } else {
                        mensagem = "<div class='alert alert-danger col-md-6'>Erro ao excluir a safra " + codigo + "</div>";
                    }
            ...
            %>
            <form method="post">
                <input type="hidden" name="sigla" value="<%=codigo%>"/>
